...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "03729c1c-a2ff-4fd6-987d-ecad6703d264",
  ...
  "public": {
    "firebase": {
      "apiKey": "AIzaSyDtbTRsZ-Ofqe5_qrnrUcd9zWxlGgicnnw",
      "authDomain": "serpenter-5ca8c.firebaseapp.com",
      "projectId": "serpenter-5ca8c",
      "storageBucket": "serpenter-5ca8c.firebasestorage.app",
      "messagingSenderId": "134300661417",
      "appId": "1:134300661417:web:99563f55985f2723bf1bb8",
      "measurementId": "G-2GHJ48C1JB"
    },
    "i18n": {
      "baseUrl": "",
      "defaultLocale": "fr",
...
const localeLoaders = {
  fr: [
    {
      key: "locale_fr_46json_aa7b9754",
      load: () => import('./fr.mjs' /* webpackChunkName: "locale_fr_46json_aa7b9754" */),
      cache: true
    }
  ],
  en: [
    {
      key: "locale_en_46json_2ae1a61e",
      load: () => import('./en.mjs' /* webpackChunkName: "locale_en_46json_2ae1a61e" */),
      cache: true
    }
  ]
};
...
const _PrS9cDzlVPrSzV2kvH4yFZvj83ttD4XT9EKDhGVaiIs = defineNitroPlugin(async (nitro) => {
  const runtimeI18n = useRuntimeI18n();
...
const plugins = [
  _PrS9cDzlVPrSzV2kvH4yFZvj83ttD4XT9EKDhGVaiIs
];
...
const _CqiCHV = defineCachedEventHandler(async (event) => {
  const url = getRequestURL(event);
  if (!url)
...
const _RwAEZI = _messagesHandlerCached;

const _SxA8c9 = defineEventHandler(() => {});

const _lazy_enttBf = () => import('../routes/api/lh.post.mjs');
const _lazy_StWHwM = () => import('../routes/api/mobile/android-manifest.post.mjs');
const _lazy_vXCZq4 = () => import('../routes/api/mobile/ios-plist.post.mjs');
const _lazy_snM5GE = () => import('../routes/api/mobile/metadata.post.mjs');
const _lazy_ZOJARO = () => import('../routes/api/security-headers.post.mjs');
const _lazy_Uq9qnP = () => import('../routes/api/security-observatory.post.mjs');
const _lazy_aEYIX0 = () => import('../routes/api/security-ssl.post.mjs');
const _lazy_UpXK6P = () => import('../routes/api/security-vulnerabilities.post.mjs');
const _lazy_rTkmqo = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/api/lh', handler: _lazy_enttBf, lazy: true, middleware: false, method: "post" },
  { route: '/api/mobile/android-manifest', handler: _lazy_StWHwM, lazy: true, middleware: false, method: "post" },
  { route: '/api/mobile/ios-plist', handler: _lazy_vXCZq4, lazy: true, middleware: false, method: "post" },
  { route: '/api/mobile/metadata', handler: _lazy_snM5GE, lazy: true, middleware: false, method: "post" },
  { route: '/api/security-headers', handler: _lazy_ZOJARO, lazy: true, middleware: false, method: "post" },
  { route: '/api/security-observatory', handler: _lazy_Uq9qnP, lazy: true, middleware: false, method: "post" },
  { route: '/api/security-ssl', handler: _lazy_aEYIX0, lazy: true, middleware: false, method: "post" },
  { route: '/api/security-vulnerabilities', handler: _lazy_UpXK6P, lazy: true, middleware: false, method: "post" },
  { route: '/__nuxt_error', handler: _lazy_rTkmqo, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _CqiCHV, lazy: false, middleware: false, method: undefined },
  { route: '/_i18n/:locale/messages.json', handler: _RwAEZI, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_rTkmqo, lazy: true, middleware: false, method: undefined }
];
...
export { appRootTag as a, appRootAttrs as b, createError$1 as c, defineEventHandler as d, appSpaLoaderTag as e, appSpaLoaderAttrs as f, getRouteRulesForPath as g, buildAssetsURL as h, useRuntimeConfig as i, joinHeaders as j, getResponseStatusText as k, getResponseStatus as l, appId as m, normalizeCookieHeader as n, defineRenderHandler as o, publicAssetsURL as p, appTeleportTag as q, readBody as r, appTeleportAttrs as s, getQuery as t, useNitroApp as u, appHead as v, destr as w, getRouteRules as x };
