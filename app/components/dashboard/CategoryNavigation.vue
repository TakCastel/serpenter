<template>
  <div v-if="isClient && hasProjects && currentProject?.checklistType" class="mb-6">
    <!-- Navigation des catégories -->
    <div class="card p-4" style="background-color: var(--bg-surface); border: 1px solid var(--bg-border);">
      <h3 class="text-sm font-semibold mb-3 transition-colors duration-200 tracking-wide" style="color: var(--text-primary);">
      ...
      <!-- Navigation des catégories -->
      <nav v-else class="flex flex-wrap gap-2" role="navigation" :aria-label="$t('app.navigation.verificationsDescription')">
        <button
