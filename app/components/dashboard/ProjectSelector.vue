    ...
    >
      <div class="space-y-4">
        <div>
          <label
            for="project-name"
            class="block text-sm font-semibold mb-2 transition-colors duration-200"
    ...
    >
      <div>
        <p class="text-gray-700 dark:text-gray-300">
          Attention, cette action va supprimer définitivement le projet
...
import SkeletonProjectSelector from "~/components/common/SkeletonProjectSelector.vue";
