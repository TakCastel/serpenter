<template>
  <section>
    <div class="card w-full p-8 md:p-10">
      <div class="mb-6">
        <h1 class="text-2xl font-bold" style="color: var(--text-primary);">Connexion</h1>
        <p class="text-sm mt-1" style="color: var(--text-secondary);">Accédez à votre dashboard Serpenter.</p>
      </div>
      <form @submit.prevent="onSubmit" class="space-y-4">
        ...
        <button type="submit" class="w-full btn btn-primary mt-2">Se connecter</button>
      </form>
      ...
      <div class="mt-4 flex items-center justify-between text-sm" style="color: var(--text-secondary);">
