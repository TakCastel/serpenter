// Option 2
import { getAuth, onAuthStateChanged, signInWithEmailAndPassword, createUserWithEmailAndPassword, sendPasswordResetEmail, signOut, setPersistence, browserLocalPersistence } from 'firebase/auth'
...
export function useAuth() {
  ...
  return { currentUser, isReady, login, register, forgotPassword, logout }
}
