/**
 * Composable pour vérifier les en-têtes de sécurité côté client
...
export const useSecurityHeaders = () => {
  const checkSecurityHeaders = async (url) => {
    try {
      ...
      if (!response) {
        throw new Error("Impossible d'accéder à l'URL fournie");
      }
      ...
      throw new Error(error.message || 'Erreur lors de la vérification des en-têtes');
    }
  };
